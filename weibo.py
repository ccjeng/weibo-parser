...
firefox_capabilities['binary'] = '/Dropbox/Project/weibo/geckodriver'

# 先调用无界面浏览器PhantomJS或Firefox
#driver = webdriver.PhantomJS(executable_path="/Dropbox/Project/weibo/phantomjs-2.1.1-macosx/bin/phantomjs")
...
def LoginWeibo(username, password):
    try:
        ...
        elem_pwd = driver.find_element_by_xpath(
            "/html/body/div[2]/form/div/input[2]")
...
def GetComment(key):
    try:
        ...
        # 输入主题并点击搜索
        item_inp = driver.find_element_by_xpath(
            "//div[@class='c']/form/div/input")  # name=keyword
        ...
        while N <= 10:
            ...
            url_get = driver.find_element_by_xpath(
                "//div[@id='pagelist']/form/div/a")
            ...
            content = driver.find_elements_by_xpath("//div[@class='c']")
            # content = driver.find_elements_by_xpath(
            #    "//div[@class='c']/div/span[@class='ctt']")
            print content
            i = 0
